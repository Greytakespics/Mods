LOVELY_INTEGRITY = '202bf44b5193416fb74effbca00e516db8a231d30764bb7c7417d323ec673951'
...
function Card:add_to_deck(from_debuff)
    ...
    if not self.added_to_deck then
        ...
        if G.GAME.blind and (not SMODS or G.GAME.blind.in_blind) and not (Talisman.config_file.disable_anims and (Talisman.calculating_joker or Talisman.calculating_score or Talisman.calculating_card)) then G.E_MANAGER:add_event(Event({ func = function() G.GAME.blind:set_blind(nil, true, nil); return true end })) end
    end
end
